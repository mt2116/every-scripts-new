                    ...
                    if (safeGet(data)) {
                        ...
                        if (data.status) {
                            ...
                            for (let i = 0; i < missions.length; ++i) {
                                ...
                                if (
                                    mission['missionStatus'] === 0 &&
                                    (mission['missionType'] === 1 || mission['missionType'] === 5)
                                ) {
                    ...
                    if (safeGet(data)) {
                        ...
                        if (data.status) {
                            if (data.data.remainPoint >= data.data.oncePoint) {
                                console.log(
                                    `当前赛点：${data.data.remainPoint}/${data.data.oncePoint}，可以兑换京豆，请打开APP兑换`
                                )
...
function taskUrl(function_id, body = {}) {
    return {
        url: `${JD_API_HOST}${function_id}?timestamp=${
