...
let cookiesArr = [],
    ...
    message = ''
const inviteCodes = [
    '4z0kxs***yvfljo4kDS7ebcg==@904gIBQsCl27Dkz6YEcK9Q==@gsUV7I8Wo9p5UQnD9MkvGQ==@LnzZf8egOoHBgDgG5u5zRat9zd5YaBeE@9F3UWp7TGc-e49MwIK6zNg==@ERVeCOPrqffEg85PYvPPe6t9zd5YaBeE@TZ4uX3vfBP3_f5wloKfI3qt9zd5YaBeE@UZhpBKY6ij7A9k9ia0x7YbuJAJD3UR5d@Jrq4wjfKnWiJioaqMvvyiKt9zd5YaBeE@YNdCzViR7-Ckqt4EL9nIwat9zd5YaBeE@aA_ZEPnhDVOGOrN0vR1LY6t9zd5YaBeE@ac8o_jIggpSEp0CtlKUXwKt9zd5YaBeE@DJPVx1MBRrPidat8FfOPeqt9zd5YaBeE',
    '4z0kxs***yvfljo4kDS7ebcg==@904gIBQsCl27Dkz6YEcK9Q==@gsUV7I8Wo9p5UQnD9MkvGQ==@4z0kxs***yvfljo4kDS7ebcg==@LnzZf8egOoHBgDgG5u5zRat9zd5YaBeE@9F3UWp7TGc-e49MwIK6zNg==@ERVeCOPrqffEg85PYvPPe6t9zd5YaBeE@4z0kxs***yvfljo4kDS7ebcg==@TZ4uX3vfBP3_f5wloKfI3qt9zd5YaBeE@UZhpBKY6ij7A9k9ia0x7YbuJAJD3UR5d@Jrq4wjfKnWiJioaqMvvyiKt9zd5YaBeE@YNdCzViR7-Ckqt4EL9nIwat9zd5YaBeE@aA_ZEPnhDVOGOrN0vR1LY6t9zd5YaBeE@ac8o_jIggpSEp0CtlKUXwKt9zd5YaBeE@DJPVx1MBRrPidat8FfOPeqt9zd5YaBeE',
    '4z0kxs***yvfljo4kDS7ebcg==@904gIBQsCl27Dkz6YEcK9Q==@gsUV7I8Wo9p5UQnD9MkvGQ==@4z0kxs***yvfljo4kDS7ebcg==@LnzZf8egOoHBgDgG5u5zRat9zd5YaBeE@9F3UWp7TGc-e49MwIK6zNg==@ERVeCOPrqffEg85PYvPPe6t9zd5YaBeE',
    '4z0kxs***yvfljo4kDS7ebcg==@904gIBQsCl27Dkz6YEcK9Q==@gsUV7I8Wo9p5UQnD9MkvGQ==@4z0kxs***yvfljo4kDS7ebcg==@LnzZf8egOoHBgDgG5u5zRat9zd5YaBeE@9F3UWp7TGc-e49MwIK6zNg==@ERVeCOPrqffEg85PYvPPe6t9zd5YaBeE',
            ...
            (i = l),
                ...
                (g = f(
                    (g = f(
                        ...
                        (v = f(
                            v,
                            (m = f(m, (l = f(l, g, v, m, n[e + 8], 6, 1873313359)), g, v, n[e + 15], 10, -30611744)),
                            l,
                            g,
                            n[e + 6],
                            15,
                    ...
                    (v = f(
                        v,
                        (m = f(m, (l = f(l, g, v, m, n[e + 4], 6, -145523070)), g, v, n[e + 11], 10, -1120210379)),
                        l,
                        g,
                        n[e + 2],
                        15,
...
async function doTasks() {
    ...
    for (let j = 0; j < $.taskList.length; ++j) {
        ...
        if (task.status === 2) await awardTask(task.taskId)
    }
}
                ...
                if (err) {
                    ...
                    if (safeGet(data)) {
                        ...
                        if (data.success && data.data && data.data.userInviteCode) {
                            console.log(
                                `\n【京东账号${$.index}（${$.nickName || $.UserName}）的${$.name}好友互助码】${
                ...
                if (err) {
                    ...
                    if (safeGet(data)) {
                        ...
                        if (data.success && data.data && data.data.taskTitle) {
                            console.log(
                                `任务【${data.data.taskTitle}】领奖成功，任务奖励：${data.data.beans}京豆，${data.data.coins}金币`
                            )
                        } else {
        ...
        $.get(taskUrl('crazyJoy_user_getJdBeanInfo'), async (err, resp, data) => {
            try {
                if (err) {
                    ...
                    if (safeGet(data)) {
                        data = JSON.parse(data)
                        if (data.success && data.data && data.data.totalBeans) $.bean = data.data.totalBeans
                        else console.log(`获取信息失败`)
                    }
                }
            } catch (e) {
                $.logErr(e, resp)
